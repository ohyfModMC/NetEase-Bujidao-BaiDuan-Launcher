...
public class OpenCommandKeyBindings {
    public static KeyMapping openCommand;

    public static void init() {
        openCommand = new KeyMapping("key.opencommand", 297, "key.categories.gameplay");
        RegisterKeyMappingsEvent event = new RegisterKeyMappingsEvent(Minecraft.m_91087_().f_91066_);
        event.register(openCommand);
    }
}
