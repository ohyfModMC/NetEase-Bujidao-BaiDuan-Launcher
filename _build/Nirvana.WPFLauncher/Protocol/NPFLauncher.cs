...
public static class NPFLauncher {
    ...
    */
    ...
    /// <summary>
    /// 调试用: 返回完整 API 响应(含 code/message/data)
    /// </summary>
    public static async Task<EntitiesWPFLauncher<EntityUserGameTexture>?> GetSkinListInGameAAsyncRaw(EntityUserGameTextureRequest userGame)
    {
        return await X19Extensions.Gateway.ApiAsync<EntitiesWPFLauncher<EntityUserGameTexture>>("/user-game-skin/query/search-by-type", userGame);
    }
